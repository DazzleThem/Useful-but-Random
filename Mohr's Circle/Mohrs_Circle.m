%This program graphs a Mohr's circle for input values of normal
%stresses and shear stresses. Note the shear stresses will have the same
%magnitude.
%INPUTS 3
...
%DEFAULTS
%Theta = t is always in degrees from 0 to 180


t = 0; %set up t to be our counter in the for loop
