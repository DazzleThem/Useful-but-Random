Mohr's Circle is a program that graphs all possible shear and normal stresses for a section. Note that tauxy and tauyx will have the same magnitude and are given the same variable name. 
